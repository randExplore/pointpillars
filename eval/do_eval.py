...
# https://github.com/open-mmlab/OpenPCDet/blob/master/pcdet/datasets/kitti/kitti_object_eval_python/eval.py
...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    CLASS_NAMES = ['pedestrian', 'cyclist', 'car', 'van', 'person_sitting', 'truck']
    MIN_HEIGHT = [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
...
def eval_class(gt_annos,
    ...
    Args:
        ...
        current_classes: list of int, 2: car, 0: pedestrian, 1: cyclist
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.5, 0.5, 0.7, 0.7,
                             0.5, 0.7], [0.5, 0.5, 0.7, 0.7, 0.5, 0.7],
                            [0.5, 0.5, 0.7, 0.7, 0.5, 0.7]])
    overlap_0_5 = np.array([[0.5, 0.5, 0.7, 0.7,
                             0.5, 0.5], [0.25, 0.25, 0.5, 0.5, 0.25, 0.5],
